...
constexpr int8_t motorPin = 7;
VibrationMotor hapticFeedback(motorPin);

const uint8_t buzzerPin = 1;
const uint32_t frequency = 440;
const uint8_t resolution = 8;

ToneESP32 buzzer(buzzerPin, frequency, resolution);
...
void loop() {
  ...
  if (game_state == 0) {
    ...
    outlineTextAtCenter(1, "Happy Birthday COCO");
